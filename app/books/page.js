      ...
      <div className="bg-gradient-to-r from-slate-900 via-purple-900 to-slate-900 py-16 border-t border-purple-500/20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <p className="text-purple-300 font-black text-lg mb-6 uppercase tracking-wider">
              Trusted By Service Business Owners
            </p>
            <p className="text-xl text-gray-300 leading-relaxed">
              Learn the exact strategies we use to help B2B service businesses book more qualified appointments and grow their revenue.
            </p>
          </div>
        </div>
      </div>
